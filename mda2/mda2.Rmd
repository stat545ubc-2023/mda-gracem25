...
I will write the tree_count_by_species_high_to_low summary table that I created for Research Question 2 in Task 1 as a csv file into my repository.
...
saveRDS(diameter_age_lm, 
        here::here("diameter_age_lm.rds"))

readRDS("diameter_age_lm.rds")
