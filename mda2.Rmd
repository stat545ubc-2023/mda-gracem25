...
From summarizing activities, I will be completing Task 1: Compute the *range*, *mean*, and *two other summary statistics* of **one numerical variable** across the groups of **one categorical variable** from your data. I will compute the range, mean, maximum and minimum values for tree diameter (which I partially did as an aside for Research Question 3 above) - there aren't many numerical variables in 
